...
int main() {
    ...
    Shader shaderProgram("include/shader/shader.vert", "include/shader/shader.frag");
    ...
    // move camera back 4 units at the z axis and rotate a lil
    glm::mat4 view = glm::mat4(1.0f);
    //view = glm::translate(view, glm::vec3(0.0f,-0.5f, -15.0f));
    view = glm::rotate(view, glm::radians(15.0f), glm::vec3(10.0f, 10.0f, 10.0f));
    // projection
    ...
    // render loop
        while(!glfwWindowShouldClose(window)) { 
            ...
            glm::mat4 view = glm::lookAt(cameraPos, glm::vec3(0.0f,0.0f,0.0f), glm::vec3(10.0f,10.0f,25.0f));
    ...
    cout << "Engine Stop Render" << endl;
    glfwTerminate();
    cout << "Engine Terminate" << endl;
    return 0;
}